export const VDT = {
  ...
  required: value => (value !== undefined ? (value.toString().length > 0) : false),
  ...
  rangelength(value, param) {
    const length = VDT.isarr(value) ? value.length : this.getLength(value);
